...
class DocScanner(object):
    ...
    def __init__(
        self, interactive=False, MIN_QUAD_AREA_RATIO=0.25, MAX_QUAD_ANGLE_RANGE=40
    ):
        """
        Args:
    ...
    def get_contour(self, rescaled_image):
        ...
        if len(test_corners) >= 4:
            ...
            for quad in itertools.combinations(test_corners, 4):
                ...
                points = imutils.order_points(points)
    ...
    def scan(self, image_path):
        ...
        warped = imutils.four_point_transform(orig, screenCnt * ratio)
